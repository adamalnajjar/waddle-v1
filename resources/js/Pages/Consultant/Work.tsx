...
interface ConsultantWorkProps extends PageProps {
...
export default function ConsultantWork() {
  const { invitations = [], counts = { pending: 0, accepted: 0 } } = usePage<ConsultantWorkProps>().props;
  ...
  const handleAccept = async (invitationId: number) => {
    ...
    router.post(`/consultant/invitations/${invitationId}/accept`, {}, {
      onError: () => setError('Failed to accept invitation'),
  ...
  const handleDecline = async (invitationId: number) => {
    ...
    setProcessingId(invitationId);
    router.post(`/consultant/invitations/${invitationId}/decline`, {}, {
      onError: () => setError('Failed to decline invitation'),
      onFinish: () => setProcessingId(null),
    });
  };
      ...
      <div className="min-h-screen bg-background py-12">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            ...
            <Card className="cursor-pointer hover:border-primary transition-colors" onClick={() => router.visit('/consultant/schedule')}>
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex items-center justify-between pt-4 border-t border-border">
                        <Button
                          variant="ghost"
                          size="sm"
                          onClick={() => router.visit(`/consultant/work/${invitation.id}`)}
                        >
                          View Details
