            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="mt-1 flex flex-wrap gap-2">
                        @if($record->tech_stack)
                            @foreach($record->tech_stack as $tech)
                ...
                @if($record->error_logs)
                    <div class="col-span-full">
                        ...
                        <pre class="mt-1 text-sm text-gray-900 dark:text-white bg-gray-100 dark:bg-gray-800 p-3 rounded-lg overflow-x-auto">{{ $record->error_logs }}</pre>
                    </div>
                @endif
            </div>
        </x-filament::section>
